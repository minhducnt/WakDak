                                                                          ...
                                                                          return InkWell(
                                                                            onTap: () async {
                                                                              ...
                                                                              if (context.read<AuthCubit>().getId().isEmpty ||
                                                                                ...
                                                                                if (widget.dataItem.variants![0].addOnsData!.isEmpty) {
                                                                                  for (int i = 0;
                                                                                      i < widget.dataItem.variants![0].addOnsData!.length;
                                                                                      i++) {
                                                                                    productAddOnIds
                                                                                        .add(widget.dataItem.variants![0].addOnsData![i].id!);
                                                                                  }
                                                                                }
                                                                              }
                                                                              if (widget.dataItem.productAddOns!.isNotEmpty) {
                                                                                for (int j = 0; j < widget.dataItem.productAddOns!.length; j++) {
                                                                                  ProductAddOnsModel data = widget.dataItem.productAddOns![j];
                                                                          ...
                                                                          if (context.read<AuthCubit>().getId().isEmpty ||
                                                                            ...
                                                                            if (widget.dataItem.variants![0].addOnsData!.isEmpty) {
                                                                              for (int i = 0;
                                                                                  i < widget.dataItem.variants![0].addOnsData!.length;
                                                                                  i++) {
                                                                                productAddOnIds.add(widget.dataItem.variants![0].addOnsData![i].id!);
                                                                              }
                                                                            }
                                                                          }
                                                                          if (widget.dataItem.productAddOns!.isNotEmpty) {
